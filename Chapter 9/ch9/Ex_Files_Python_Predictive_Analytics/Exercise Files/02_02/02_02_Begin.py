...
# invoke LinearRegression
lr_poly=LinearRegression()
# train the model
poly_lr = lr_poly.fit(X_train, y_train)
...
#how good is the prediction out of sample
r2_test=poly_lr.score(X_test, y_test)

print(r2_test)

#how good is the prediction out of sample
r2_train=poly_lr.score(X_train, y_train)
print(r2_train)
...
#how good is the prediction out of sample
r2_train=svr.score(y_train, y_train_pred)
print(r2_train)
